...
/* *****************************************************************************
	Build Stored Procedure sp_get_all_Animals
***************************************************************************** */
DELIMITER $$
DROP PROCEDURE IF EXISTS sp_get_all_Animals$$
CREATE PROCEDURE sp_get_all_Animals()
BEGIN
	SELECT
        animal_id,
        animal_name,
...
CALL sp_add_animal('test2','Liz', 'dog', 'Female'
, 22, 0, 4, 015.50, '2020-11-10', '2020-11-18 12:30:15');
CALL sp_add_animal('test3','Scales', 'cat', 'Male'
...
, 'cat ', 'Female', 30, 1, 4, 050.40, '2020-11-18'
, '2020-11-18 12:30:15');
